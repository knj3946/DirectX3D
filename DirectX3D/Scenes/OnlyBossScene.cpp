#include "Framework.h"
#include "OnlyBossScene.h"

OnlyBossScene::OnlyBossScene()
{
...
void OnlyBossScene::Update()
{
	MenuManager::Get()->FirstLoading(bind(&OnlyBossScene::FirstLoading, this));
...
void OnlyBossScene::FirstLoading()
{
